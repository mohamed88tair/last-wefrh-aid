...
import { Package, FileText, DollarSign, Weight, Plus, Trash2, Save, X, AlertTriangle, CheckCircle, List, Edit } from 'lucide-react';
import { type PackageTemplate, type PackageItem } from '../data/mockData';
