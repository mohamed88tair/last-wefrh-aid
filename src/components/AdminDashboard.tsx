...
import { Shield, Users, Package, Truck, Bell, BarChart3, Settings, MapPin, AlertTriangle, CheckCircle, Clock, Plus, Search, Filter, Download, Eye, Edit, Phone, Star, UserPlus, TrendingUp, Activity, Database, MessageSquare, UserCheck, Crown, Key, Lock, ChevronRight, RefreshCw, LogOut, Building2, FileText } from 'lucide-react';
import { Gift } from 'lucide-react';
import { mockBeneficiaries, mockPackages, calculateStats } from '../data/mockData';
...
export default function AdminDashboard({ activeTab, setActiveTab }: AdminDashboardProps) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'referral-management', name: 'نظام الإحالة', icon: Gift }
      ]
    },
    {
      id: 'development',
  ...
  const getPageDescription = (tabId: string) => {
    const descriptions: { [key: string]: string } = {
      ...
      'bulk-send': 'إرسال طرود لعدة مستفيدين',
      ...
      'referral-management': 'إدارة رموز الإحالة ومتابعة المدفوعات',
    };
  ...
  const renderMainContent = () => {
      ...
      return (
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <Card hover onClick={() => setActiveTab('tracking')}>
              <div className="flex items-center space-x-3 space-x-reverse mb-4">
                <div className="w-8 h-8 bg-orange-50 rounded-lg flex items-center justify-center">
                  <Truck className="w-4 h-4 text-orange-600" />
                </div>
                <h3 className="text-lg font-semibold text-gray-900">تتبع الإرسالات</h3>
              </div>
              <p className="text-gray-600 mb-4 text-sm">تتبع حالة الطرود والتوزيع</p>
    ...
    if (activeTab === 'referral-management') {
      return (
        <div className="space-y-6">
          <div className="flex items-center space-x-4 space-x-reverse">
            <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center">
