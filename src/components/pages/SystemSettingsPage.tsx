...
export default function SystemSettingsPage() {
  ...
  const [systemSettings, setSystemSettings] = useState<SystemSetting[]>([
    ...
    },
    {
      id: '11',
      category: 'notifications',
      key: 'tweetsms_api_key',
      name: 'مفتاح API لخدمة TweetSMS',
      description: 'مفتاح API الخاص بخدمة TweetSMS لإرسال الرسائل النصية',
      value: '04e56a90592de205c8c0938efc7b52a5f564911f9f12beeb0258271897414f59',
      type: 'password',
      isSecret: true,
      lastModified: '2024-12-20',
      modifiedBy: 'أحمد الإدمن'
    },
    {
      id: '18',
      category: 'notifications',
      key: 'tweetsms_sender_name',
      name: 'اسم المرسل في الرسائل النصية',
      description: 'الاسم الذي سيظهر كمرسل في الرسائل النصية المرسلة',
      value: 'منصة المساعدات',
      type: 'text',
      lastModified: '2024-12-21',
      modifiedBy: 'أحمد الإدمن'
    },
    {
      id: '19',
      category: 'notifications',
      key: 'tweetsms_balance_check',
      name: 'فحص الرصيد التلقائي',
      description: 'فحص رصيد خدمة الرسائل النصية تلقائياً عند بدء تشغيل النظام',
      value: 'true',
      type: 'boolean',
      lastModified: '2024-12-21',
      modifiedBy: 'أحمد الإدمن'
                    ...
                    <div className="flex items-start space-x-3 space-x-reverse">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-2 space-x-reverse mt-2 text-xs text-gray-500">
                          <span>آخر تعديل: {new Date(setting.lastModified).toLocaleDateString('en-CA')}</span>
                          <span>•</span>
