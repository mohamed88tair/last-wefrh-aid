...
import { mockPackageTemplates, type PackageTemplate, type PackageItem } from '../../data/mockData';
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4">
        <div className="flex items-center space-x-2 space-x-reverse text-blue-600">
          ...
          <span className="text-sm font-medium">
            البيانات الوهمية محملة - {templates.length} قالب
          </span>
        </div>
      </div>
                      ...
                      <div className="space-y-3 text-sm"> {/* Fix: usage_count is not status */}
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-gray-900">
                            {new Date(selectedTemplate.createdAt).toLocaleDateString('en-CA')}
                          </span>
                        </div>
                      </div>
                    </div>
