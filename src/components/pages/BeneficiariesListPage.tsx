...
import { Users, Search, Filter, Plus, Eye, Edit, Phone, MessageSquare, CheckCircle, Clock, AlertTriangle, Shield, UserCheck, Download, Star, UserPlus, Gift } from 'lucide-react';
import { type Beneficiary } from '../../data/mockData';
import { mockSystemUsers, mockReferralCodes } from '../../data/mockData';
      ...
      <Card>
        <div className="flex items-center space-x-4 space-x-reverse">
          ...
          <Button 
            ...
            iconPosition="right"
            onClick={() => {
              alert('الفلترة المتقدمة قيد التطوير\n\nستتضمن:\n• فلترة حسب المحافظة والمدينة\n• فلترة حسب حالة التوثيق\n• فلترة حسب تاريخ التسجيل\n• فلترة حسب عدد الطرود المستلمة\n• فلترة حسب المستوى الاقتصادي');
            }}
          >
            فلترة متقدمة
          </Button>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {beneficiary.referredByCode ? (
                          <div className="text-center">
                            <code className="bg-blue-100 px-2 py-1 rounded text-xs font-mono text-blue-600">
                              {beneficiary.referredByCode}
                            </code>
                          </div>
                        ) : (
                          <span className="text-xs text-gray-400">بدون إحالة</span>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
