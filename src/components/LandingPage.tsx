...
import { Shield, Users, MapPin, Package, Truck, BarChart3, Bell, ArrowRight, ArrowLeft } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-1 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-colors">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                التحكم الكامل في النظام، إدارة المستفيدين، المندوبين والتقارير الشاملة
              </p>
